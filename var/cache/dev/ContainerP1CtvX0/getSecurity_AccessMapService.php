...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/registrar-posts'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/mis-posts'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/post'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'], NULL);
