 ...
 */
class getProfesionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfesionRepository' shared autowired service.
     *
     * @return \App\Repository\ProfesionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfesionRepository.php';

        return $container->privates['App\\Repository\\ProfesionRepository'] = new \App\Repository\ProfesionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
